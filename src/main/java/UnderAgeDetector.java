 ...
 */
public class UnderAgeDetector {
    public static void main(String[] args) {
        System.out.println("Please state your date of birth in format: dd.MM.yyyy");
        Scanner bt = new Scanner(System.in);
        String dateOfbirth = bt.nextLine();

        SimpleDateFormat format = new SimpleDateFormat("dd.MM.yyyy");
        Date dateOfbirth = format.parse(dateOfbirth);
